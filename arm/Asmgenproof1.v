...
Lemma loadind_correct:
  ...
  Mem.loadv (chunk_of_type (typ_of_quantity q)) m (Val.offset_ptr rs#base ofs) = Some v ->
  exists rs',
...
Lemma storeind_correct:
  ...
  Mem.storev (chunk_of_type (typ_of_quantity q)) m (Val.offset_ptr rs#base ofs) (rs#(preg_of src)) = Some m' ->
  exists rs',
     exec_straight ge fn c rs m k rs' m'
