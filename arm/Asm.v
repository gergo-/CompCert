...
Inductive instruction : Type :=
  ...
  | Pflds_a: sreg -> ireg -> int -> instruction     (**r any32 load to FP reg *)
  ...
  | Pfsts_a: sreg -> ireg -> int -> instruction     (**r any32 store from FP reg *)
...
Inductive extcall_arg (rs: regset) (m: mem): loc -> val -> Prop :=
  ...
  | extcall_arg_stack: forall ofs q bofs v,
      ...
      Mem.loadv (chunk_of_type (typ_of_quantity q)) m
