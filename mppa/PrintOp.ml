...
let print_condition reg pp = function
  ...
  | (Ccomplimm(c, n), [r1]) ->
      fprintf pp "%a %sls %ld" reg r1 (comparison_name c) (camlint_of_coqint n)
  | (Ccompluimm(c, n), [r1]) ->
      fprintf pp "%a %slu %ld" reg r1 (comparison_name c) (camlint_of_coqint n)
  | (Ccompf c, [r1;r2]) ->
...
let print_operation reg pp = function
  ...
  | Osbf, [r1;r2] -> fprintf pp "%a - %a" reg r2 reg r1
  | Osbfimm n, [r1] -> fprintf pp "%ld - %a" (camlint_of_coqint n) reg r1
  ...
  | Oaddlimm n, [r1] -> fprintf pp "%a +l %ld" reg r1 (camlint_of_coqint n)
  | Osbfl, [r1;r2] -> fprintf pp "%a -l %a" reg r2 reg r1
  | Osbflimm n, [r1] -> fprintf pp "%ld -l %a" (camlint_of_coqint n) reg r1
  | Oandl, [r1;r2] -> fprintf pp "%a &l %a" reg r1 reg r2
  | Oandlimm n, [r1] -> fprintf pp "%a &l %ld" reg r1 (camlint_of_coqint n)
  | Oorl, [r1;r2] -> fprintf pp "%a |l %a" reg r1 reg r2
  | Oorlimm n, [r1] ->  fprintf pp "%a |l %ld" reg r1 (camlint_of_coqint n)
  | Oxorl, [r1;r2] -> fprintf pp "%a ^l %a" reg r1 reg r2
  | Oxorlimm n, [r1] -> fprintf pp "%a ^l %ld" reg r1 (camlint_of_coqint n)
  | Onotl, [r1] -> fprintf pp "notl(%a)" reg r1
  | Oshll, [r1;r2] -> fprintf pp "%a <<l %a" reg r1 reg r2
  | Oshrl, [r1;r2] -> fprintf pp "%a >>sl %a" reg r1 reg r2
  | Oshrlu, [r1;r2] -> fprintf pp "%a >>ul %a" reg r1 reg r2
  | Onegf, [r1] -> fprintf pp "negf(%a)" reg r1
  | Oabsf, [r1] -> fprintf pp "absf(%a)" reg r1
  | Oaddf, [r1;r2] -> fprintf pp "%a +f %a" reg r1 reg r2
  | Osbff, [r1;r2] -> fprintf pp "%a -f %a" reg r2 reg r1
  ...
  | Osbffs, [r1;r2] -> fprintf pp "%a -fs %a" reg r2 reg r1
