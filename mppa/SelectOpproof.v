...
Theorem eval_sbfimm: forall n, unary_constructor_sound (sbfimm n) (fun v => Val.sub (Vint n) v).
Proof.
  red; intros until x. unfold sbfimm; case (sbfimm_match a); intros.
...
Theorem eval_sbf: binary_constructor_sound sbf (fun v1 v2 => Val.sub v2 v1).
Proof.
  red; intros until y.
  unfold sbf; case (sbf_match a b); intros; InvEval.
  ...
  apply eval_sbfimm; auto.
  subst. TrivialExists.
Qed.

Theorem eval_sub: binary_constructor_sound sub Val.sub.
Proof.
  red; intros; apply eval_sbf; auto.
Qed.

Theorem eval_negint: unary_constructor_sound negint Val.neg.
Proof.
  red; intros until x.
  unfold negint; case (negint_match a); intros; InvEval; TrivialExists.
Qed.
...
Proof.
  ...
  eapply eval_Eop. eapply eval_Econs. eapply eval_Eop.
  eapply eval_Econs. eapply eval_Eop.
  eapply eval_Econs. eapply eval_Eletvar.
  simpl; reflexivity.
  ...
  apply eval_Enil.
  simpl; reflexivity.
  apply eval_Econs. eapply eval_Eletvar. reflexivity. eapply eval_Enil.
  reflexivity.
Qed.
...
Theorem eval_sbff: binary_constructor_sound sbff (fun v1 v2 => Val.subf v2 v1).
Proof.
  red; intros; TrivialExists.
Qed.
...
Theorem eval_sbffs: binary_constructor_sound sbffs (fun v1 v2 => Val.subfs v2 v1).
Proof.
  red; intros; TrivialExists.
Qed.
