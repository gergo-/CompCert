...
- inv H. simpl in H6. TrivialExists.
  destruct vl; inv H6. destruct vl; inv H1.
  simpl. rewrite Val.addl_assoc, Int64.add_commut; auto.
- TrivialExists.
Qed.
...
- subst. rewrite <- Val.addl_assoc. apply eval_addlimm. EvalOp.
- TrivialExists.
Qed.

Theorem eval_sbflimm: forall n, unary_constructor_sound (sbflimm n) (fun v => Val.subl (Vlong n) v).
Proof.
  red; intros until x. unfold sbflimm; destruct (sbflimm_match a); intros; InvEval.
- TrivialExists.
- subst x. econstructor; split. EvalOp. unfold eval_operation; eauto.
  destruct v1; simpl; auto. rewrite Int64.sub_add_r, <- Int64.sub_add_opp. auto.
- subst x. econstructor; split. EvalOp. simpl; auto.
  fold (Val.subl (Vlong m0) v1). destruct v1; simpl; auto.
  rewrite !Int64.sub_add_opp, Int64.neg_add_distr, Int64.neg_involutive.
  rewrite (Int64.add_permut i), (Int64.add_commut i). auto.
- TrivialExists.
Qed.

Theorem eval_sbfl: binary_constructor_sound sbfl (fun v1 v2 => Val.subl v2 v1).
Proof.
  red; intros until y. unfold sbfl. destruct (sbfl_match a b); intros; InvEval.
...
- subst. rewrite Val.subl_addl_r. apply eval_addlimm; EvalOp.
- apply eval_sbflimm; auto.
- TrivialExists.
Qed.
...
Proof.
  ...
  red; intros; apply eval_sbfl; auto.
Qed.
