...
- destruct (Int.eq_dec n Int.zero && vincl v1 (Uns Ptop 1)) eqn:E0.
  ...
  exploit Y; eauto. intros [A | [A | A]]; rewrite A; simpl; auto.
  apply make_cmp_base_correct; auto.
- destruct (Int64.eq_dec n Int64.one && vincl v1 (Uns Ptop 1)) eqn:E1.
  simpl in H; inv H. InvBooleans. subst n.
  exists (rs#r1); split; auto. simpl.
  exploit Y; eauto. intros [A | [A | A]]; rewrite A; simpl; auto.
  destruct (Int64.eq_dec n Int64.zero && vincl v1 (Uns Ptop 1)) eqn:E0.
  simpl in H; inv H. InvBooleans. subst n.
  exists (Val.xorl rs#r1 (Vlong Int64.one)); split; auto. simpl.
  exploit Y; eauto. intros [A | [A | A]]; rewrite A; simpl; auto.
  apply make_cmp_base_correct; auto.
- destruct (Int64.eq_dec n Int64.zero && vincl v1 (Uns Ptop 1)) eqn:E0.
  simpl in H; inv H. InvBooleans. subst n.
