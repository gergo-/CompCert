...
Proof.
  intros; red; intros.
  unfold return_regs, Locmap.get. destruct l; auto. rewrite H; auto.
Qed.
...
Local Opaque b fe.
  ...
  unfold Locmap.get, Locmap.chunk_of_loc; simpl. destruct (chunk_of_type ty); reflexivity.
...
(* Conclusions *)
  ...
  split. rewrite LS1. apply agree_locs_undef_locs; [|reflexivity].
    ...
    unfold Locmap.get, Locmap.chunk_of_loc, call_regs.
    apply AGCS. auto.
...
Proof.
  ...
  destruct (Locmap.chunk_of_loc (R r)); simpl; auto.
  red; simpl; auto.
